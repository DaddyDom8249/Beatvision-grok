    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 mx-auto w-full max-w-5xl px-4 py-8 space-y-8">
        <div className="rounded-xl border border-[var(--bv-border)] bg-[var(--bv-surface)] p-4 text-sm text-[var(--bv-muted)] leading-relaxed">
          ...
          {draft.audioName
            ? ` (filename: ${draft.audioName}). Real duration requires audio analysis.`
            : ". Duration estimated from lyrics (or default). Real timing arrives with audio analysis."}
          {" "}No media is generated in this phase. Scenes are planning only. State is durable in the database.
        </div>
